...
```
<h4><img src="/img/icons8-output-96.png" width="30" height="30"> Output should be similler to this:</h4>
...
# Continue
 ...
 # [<img src="../img/icons8-next-96.png" width="75" height="75"> Nginx Ingress Controller setup <img src="../img/icons8-nginx-accelerates-content-and-application-delivery-improves-security-96.png" width="75" height="75">][PlDa]
